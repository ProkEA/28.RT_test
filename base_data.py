...
class AuthForm(BaseForm):
    def __init__(self, driver, timeout=5):
        ...
        self.placeholder = driver.find_element(By.XPATH, '//*[@id="page-right"]/div/div/div/form/div[1]/div['
                                                         '2]/div/span[2]')
        ...
        self.phone_tab = driver.find_element(By.ID, 't-btn-tab-phone')
        self.mail_tab = driver.find_element(By.ID, 't-btn-tab-mail')
        self.login_tab = driver.find_element(By.ID, 't-btn-tab-login')
        self.ls_tab = driver.find_element(By.ID, 't-btn-tab-ls')
